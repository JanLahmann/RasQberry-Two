...
<p style="text-align:center;"><em>Figure 1: Each sub-assembly of the Wall printed.</em></p>
...
<p style="text-align:center;"><em>Figure 2: Gorilla super glue used to glue the halves together.</em></p>
...
<p style="text-align:center;"><em>Figure 3: Gluing one half of the Wall base.</em></p>

<p style="text-align:center;"><em>Figure 4: Gluing one half of the Wall’s lid.</em></p>
...
<p style="text-align:center;"><em>Figures 5 & 6: Using clamps to hold the pieces together while they dry.</em></p>
...
<p style="text-align:center;"><em>Figure 7: Mounting location for the Micro SD card.</em></p>
...
<p style="text-align:center;"><em>Figure 8: The Raspberry Pi 5 and the Active Cooler.</em></p>
...
<p style="text-align:center;"><em>Figure 9: Removing the film from the active cooler.</em></p>
...
<p style="text-align:center;"><em>Figure 10: Correct mounting orientation for the active cooler.</em></p>

<p style="text-align:center;"><em>Figure 11: View of the plastic anchor correctly secured through the board.</em></p>
...
<p style="text-align:center;"><em>Figure 12: Fan cable plugged into the fan port.</em></p>

Now you’ve successfully mounted an active cooler to your Raspberry Pi!

<p style="text-align:center;"><em>Figure 13: Raspberry Pi 5 with Active Cooler mounted.</em></p>

### Wiring up the LED Arrays

The LED array is composed of four identical WS2812IC LED panels. Each one looks like this:

<p style="text-align:center;"><em>Figure 14: One of the LED panels.</em></p>
...
<p style="text-align:center;"><em>Figure 15: The input plug of the LED panel.</em></p>
...
<p style="text-align:center;"><em>Figure 16: Three color-coded M-F Breadboard Jumper wires.</em></p>
...
<p style="text-align:center;"><em>Figure 17: GPIO Pinout of the Pi 5, with the needed connections circled in the wire color.</em></p>
...
<p style="text-align:center;"><em>Figure 18: Wiring the Raspberry Pi.</em></p>
...
<p style="text-align:center;"><em>Figure 19: Plugging the male end of the jumper cable into the LED panel plug.</em></p>

After plugging in all three wires, it should look like this:

<p style="text-align:center;"><em>Figure 20: Plugging all three jumper cables into the LED plug.</em></p>
...
<p style="text-align:center;"><em>Figure 21: Wiring all four LED panels together.</em></p>
...
<p style="text-align:center;"><em>Figure 22: Flipping the last two LED panels underneath.</em></p>
...
<p style="text-align:center;"><em>Figure 23: Testing the proper orientation of the LED panels before slotting them into the wall.</em></p>
...
<p style="text-align:center;"><em>Figure 24: Placing the bottom row of LED panels.</em></p>
...
<p style="text-align:center;"><em>Figure 25: Both rows of LED panels lined up.</em></p>

<p style="text-align:center;"><em>Figure 26: Resting the top row on top of the bottom row.</em></p>

<p style="text-align:center;"><em>Figure 27: Testing out panel alignment using the IBM test function.</em></p>
