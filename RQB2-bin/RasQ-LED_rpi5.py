#!/usr/bin/env python3
# 
# RasQ-LED Quantum Circuit Demo - Raspberry Pi 5 Compatible Version
# Creates quantum circuits with different entanglement patterns and visualizes on LEDs
#
# Usage: python3 RasQ-LED_rpi5.py
...
def find_display_script():
    ...
    script_locations = [
        ...
        os.path.join(os.path.dirname(__file__), "RasQ-LED-display_rpi5.py"),
        # Fallback to original (might not work on RPi 5)
        os.path.join(os.path.dirname(__file__), "RasQ-LED-display.py"),
        # System paths
        "/usr/bin/RasQ-LED-display_rpi5.py",
...
def main():
    """Main entry point"""
    print("RasQ-LED Quantum Entanglement Demo (Raspberry Pi 5 Compatible)")
    print("=" * 60)
