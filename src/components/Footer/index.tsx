        ...
        <Grid >
            <Column sm="100%">
                ...
                <p style={{ fontSize: '0.875rem', marginTop: '1rem', opacity: 0.8 }}>
                    RasQberry Two is an independent educational project. IBM®, IBM Quantum®, Qiskit®, and IBM Quantum System Two are trademarks of IBM Corporation. This project is not affiliated with IBM.<br />
