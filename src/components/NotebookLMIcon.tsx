...
export function NotebookLMIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      width="20"
      height="20"
    ...
    >
      ...
      <g clipPath="url(#notebooklm-clip)">
        <path
      ...
      <defs>
        <clipPath id="notebooklm-clip">
          <rect width="10" height="7.33333" fill="white" transform="translate(3 3.5)" />
        </clipPath>
      </defs>
    </svg>
  );
