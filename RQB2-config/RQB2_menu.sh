...
pick_image() {
    ...
    if [ -z "$menu_items" ]; then
        whiptail --title "No Images" --msgbox "No image files found in release: $release_tag" 10 50 </dev/tty
        return 1
    fi
