...
install -v -m 644 "${SCRIPT_DIR}/files/systemd/rasqberry-health-check.service" \
  "${ROOTFS_DIR}/etc/systemd/system/rasqberry-health-check.service"

install -v -m 644 "${SCRIPT_DIR}/files/systemd/rasqberry-update-poller.timer" \
  "${ROOTFS_DIR}/etc/systemd/system/rasqberry-update-poller.timer"

install -v -m 644 "${SCRIPT_DIR}/files/systemd/rasqberry-update-poller.service" \
